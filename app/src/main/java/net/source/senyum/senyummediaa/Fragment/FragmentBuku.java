...
public class FragmentBuku extends Fragment {
    ...
    GridLayoutManager gridLayoutBuku,
            gridBrand;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvBrands = view.findViewById(R.id.rv_brand_buku);
        rvBrands.setHasFixedSize(true);

        rvBuku = view.findViewById(R.id.rv_menu_buku);
        rvBuku.setHasFixedSize(true);

        gridBrand = new GridLayoutManager(getContext(), 2, GridLayoutManager.HORIZONTAL, false);
        gridLayoutBuku = new GridLayoutManager(getContext(), 2, GridLayoutManager.VERTICAL, false);

        rvBuku.setLayoutManager(gridLayoutBuku);
        menuBukuRv = new MenuBukuRv(itemProduct, getContext());
        rvBuku.setAdapter(menuBukuRv);
