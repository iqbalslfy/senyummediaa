...
public class FragmentPeralatanKantor extends Fragment {

    GridLayoutManager gridLayoutPeralatan,
            gridBrand;
    ...
    MenuPeralatanKantor peralatanKantorAdapter;
    ...
    public FragmentPeralatanKantor() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_peralatan_kantor, container, false);

        brand();
        perlengkapan();

        rvBrands = view.findViewById(R.id.rv_brand_peralatan);
        rvBrands.setHasFixedSize(true);

        rvPeralatan = view.findViewById(R.id.rv_menu_peralatan);
        rvPeralatan.setHasFixedSize(true);

        gridBrand = new GridLayoutManager(getContext(), 2, GridLayoutManager.HORIZONTAL, false);
        gridLayoutPeralatan = new GridLayoutManager(getContext(), 2, GridLayoutManager.VERTICAL, false);

        rvPeralatan.setLayoutManager(gridLayoutPeralatan);
        peralatanKantorAdapter = new MenuPeralatanKantor(itemProduct, getContext());
        rvPeralatan.setAdapter(peralatanKantorAdapter);
