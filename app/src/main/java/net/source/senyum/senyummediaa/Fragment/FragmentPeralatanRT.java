...
public class FragmentPeralatanRT extends Fragment {
    GridLayoutManager gridLayoutRT,
            gridBrand;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvBrands = view.findViewById(R.id.rv_brand_RT);
        rvBrands.setHasFixedSize(true);

        rvRT = view.findViewById(R.id.rv_menu_RT);
        rvRT.setHasFixedSize(true);

        gridBrand = new GridLayoutManager(getContext(), 2, GridLayoutManager.HORIZONTAL, false);
        gridLayoutRT = new GridLayoutManager(getContext(), 2, GridLayoutManager.VERTICAL, false);

        rvRT.setLayoutManager(gridLayoutRT);
        RTAdapter = new MenuRumahTanggaRv(itemProduct, getContext());
        rvRT.setAdapter(RTAdapter);
